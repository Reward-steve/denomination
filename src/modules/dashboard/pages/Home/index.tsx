...
export default function Home() {
  ...
  return (
    <DashboardLayout>
      {openModal && <MarkAttendance setOpenModal={setOpenModal} data={selectedEvent} />}
      ...
      <div className="space-y-12">
        ...
        <div className="rounded-2xl p-3 sm:p-3 lg:p-3 max-w-5xl mx-auto space-y-8">
          ...
          <section className="grid gap-4 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2">
            ...
            {(!loadingUpcoming && upcomingEvents.length > 0) && <div className="border border-border bg-surface rounded-2xl p-3 sm:p-3 lg:p-3 space-y-3">
            ...
            {(!loadingDocs && docs.length > 0) && <div className="border border-border bg-surface rounded-2xl p-3 sm:p-3 lg:p-3 space-y-2">
              <div className="flex justify-between items-center w-full">
