...
import { useFetchAllTransactions, useFetchUserTransactions } from "../../hook/useFinance";
...
export default function TransactionHistory() {
  ...
  return (
    <DashboardLayout>
      <div className="sticky top-6 text-text my-4 text-lg font-semibold">Transactions</div>
