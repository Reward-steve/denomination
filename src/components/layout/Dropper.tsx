  ...
  return (
    <div className={className} ref={ref}>
      <div className="relative">
        ...
        <div
          className={`absolute right-0 top-[100%] w-max bg-surface border border-border rounded-lg shadow-md overflow-hidden animate ${
            showing ? "fadeInDownShort" : "fadeInUpShort"
          }`}
        >
