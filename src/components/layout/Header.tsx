...
export default function Header() {
  ...
  return (
    <nav className="sticky top-0 z-50 md:py-2 bg-dashboard">
      {isMobile ? (
        ...
        <div className="h-14 flex items-center justify-between bg-white px-4 rounded-md transition-colors">
          <form className="flex-1 max-w-md">
            <label className="flex items-center gap-2 p-2 border border-border rounded-md w-full bg-white">
          ...
          <div className="flex items-center gap-4 ml-4">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full border border-border hover:bg-gray-100 transition"
